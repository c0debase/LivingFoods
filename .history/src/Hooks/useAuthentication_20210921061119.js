...
import {set, update, push, getDatabase, ref as fireRef, get, query, onValue} from 'firebase/database';
...
const firebaseConfig = {
  ...
  databaseURL: "https://eatlivecells.firebaseio.com/"
};
...
set(push(fireRef(db, 'eatlivecells')), message);
